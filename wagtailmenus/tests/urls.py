...
urlpatterns = [
    ...
    url(r'^custom-menu-tag-fine/$', TemplateView.as_view(template_name='custom_menu_tag_page.html')),
    url(r'^custom-menu-tag-broken/$', TemplateView.as_view(template_name='custom_menu_tag_page_broken.html')),
