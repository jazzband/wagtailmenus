...
def main_menu(
    ...
    use_absolute_page_urls=False, add_sub_menu_items_inline=None, **kwargs
):
...
def flat_menu(
    ...
    add_sub_menu_items_inline=None, **kwargs
):
...
def sub_menu(
    ...
    if add_sub_menu_items_inline is None:
        add_sub_menu_items_inline = context.get('add_sub_menu_items_inline', False)
