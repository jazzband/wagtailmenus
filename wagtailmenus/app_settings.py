...
MAIN_MENU_SECTION_FROM_PATH = getattr(
    settings, 'WAGTAILMENUS_MAIN_MENU_SECTION_FROM_PATH', True
)

SECTION_MENU_SECTION_FROM_PATH = getattr(
    settings, 'WAGTAILMENUS_SECTION_MENU_SECTION_FROM_PATH', True
)

FLAT_MENU_SECTION_FROM_PATH = getattr(
    settings, 'WAGTAILMENUS_FLAT_MENU_SECTION_FROM_PATH', False
)
