...
DEFAULT_MAIN_MENU_USE_SPECIFIC = getattr(
    settings, 'WAGTAILMENUS_MAIN_MENU_FETCH_SPECIFIC_PAGES', False
)

DEFAULT_SECTION_MENU_USE_SPECIFIC = getattr(
    settings, 'WAGTAILMENUS_SECTION_MENU_FETCH_SPECIFIC_PAGES', False
)

DEFAULT_CHILDREN_MENU_USE_SPECIFIC = getattr(
    settings, 'WAGTAILMENUS_CHILDREN_MENU_FETCH_SPECIFIC_PAGES', False
)

DEFAULT_FLAT_MENU_USE_SPECIFIC = getattr(
    settings, 'WAGTAILMENUS_FLAT_MENU_FETCH_SPECIFIC_PAGES', False
)
