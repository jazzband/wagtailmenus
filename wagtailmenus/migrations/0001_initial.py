    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_page', models.ForeignKey(related_name='+', verbose_name='Link to an internal page', blank=True, to='wagtailcore.Page', null=True)),
                ('menu', modelcluster.fields.ParentalKey(related_name='menu_items', to='wagtailmenus.FlatMenu')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('site', models.OneToOneField(related_name='main_menu', to='wagtailcore.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_page', models.ForeignKey(related_name='+', verbose_name='Link to an internal page', blank=True, to='wagtailcore.Page', null=True)),
                ('menu', modelcluster.fields.ParentalKey(related_name='menu_items', to='wagtailmenus.MainMenu')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
