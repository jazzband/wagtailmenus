...
class TestDeriveSite(ArgumentFormTestMixin, TestCase):
    ...
    @mock.patch('wagtailmenus.api.v1.forms.get_site_from_request')
    ...
    @mock.patch('wagtailmenus.api.v1.forms.get_site_from_request', return_value='ABC')
    ...
    @mock.patch('wagtailmenus.api.v1.forms.get_site_from_request', return_value=None)
