...
* Fixed bug `#329 <https://github.com/rkhleics/wagtailmenus/issues/329>`_, which was preventing level-specific template naming from working as specified in the docs.
